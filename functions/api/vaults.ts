...
export const onRequestPut: PagesFunction<Env> = async (context) => {
  ...
  try {
    await env.DB.prepare("UPDATE vaults SET name = ?, r2_endpoint = ?, r2_access_key = ?, r2_secret_key = ?, r2_bucket = ? WHERE id = ?")
      .bind(name, r2_endpoint, r2_access_key, r2_secret_key, r2_bucket, vaultId).run();
